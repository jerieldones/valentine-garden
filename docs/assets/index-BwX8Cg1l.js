...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(e,t,n){let r=new Float32Array(Os),i=new W(0,1,0);return new ti({name:`SphericalGaussianBlur`,defines:{n:Os,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Gs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Us(){return new ti({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Gs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ws(){return new ti({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Gs(),fragmentShader:`
	...
	`}function Ks(e){let t=new WeakMap,n=null;function r(r){if(r&&r.isTexture){let o=r.mapping,s=o===303||o===304,c=o===301||o===302;if(s||c){let o=t.get(r),l=o===void 0?0:o.texture.pmremVersion;if(r.isRenderTargetTexture&&r.pmremVersion!==l)return n===null&&(n=new Ls(e)),o=s?n.fromEquirectangular(r,o):n.fromCubemap(r,o),o.texture.pmremVersion=r.pmremVersion,t.set(r,o),o.texture;if(o!==void 0)return o.texture;{let l=r.image;return s&&l&&l.height>0||c&&l&&i(l)?(n===null&&(n=new Ls(e)),o=s?n.fromEquirectangular(r):n.fromCubemap(r),o.texture.pmremVersion=r.pmremVersion,t.set(r,o),r.addEventListener(`dispose`,a),o.texture):null}}}return r}function i(e){let t=0;for(let n=0;n<6;n++)e[n]!==void 0&&t++;return t===6}function a(e){let n=e.target;n.removeEventListener(`dispose`,a);let r=t.get(n);r!==void 0&&(t.delete(n),r.dispose())}function o(){t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:o}}function qs(e){let t={};function n(n){if(t[n]!==void 0)return t[n];let r=e.getExtension(n);return t[n]=r,r}return{has:function(e){return n(e)!==null},init:function(){n(`EXT_color_buffer_float`),n(`WEBGL_clip_cull_distance`),n(`OES_texture_float_linear`),n(`EXT_color_buffer_half_float`),n(`WEBGL_multisampled_render_to_texture`),n(`WEBGL_render_shared_exponent`)},get:function(e){let t=n(e);return t===null&&$e(`WebGLRenderer: `+e+` extension not supported.`),t}}}function Js(e,t,n,r){let i={},a=new WeakMap;function o(e){let s=e.target;for(let e in s.index!==null&&t.remove(s.index),s.attributes)t.remove(s.attributes[e]);s.removeEventListener(`dispose`,o),delete i[s.id];let c=a.get(s);c&&(t.remove(c),a.delete(s)),r.releaseStatesOfGeometry(s),s.isInstancedBufferGeometry===!0&&delete s._maxInstanceCount,n.memory.geometries--}function s(e,t){return i[t.id]===!0?t:(t.addEventListener(`dispose`,o),i[t.id]=!0,n.memory.geometries++,t)}function c(n){let r=n.attributes;for(let n in r)t.update(r[n],e.ARRAY_BUFFER)}function l(e){let n=[],r=e.index,i=e.attributes.position,o=0;if(r!==null){let e=r.array;o=r.version;for(let t=0,r=e.length;t<r;t+=3){let r=e[t+0],i=e[t+1],a=e[t+2];n.push(r,i,i,a,a,r)}}else if(i!==void 0){let e=i.array;o=i.version;for(let t=0,r=e.length/3-1;t<r;t+=3){let e=t+0,r=t+1,i=t+2;n.push(e,r,r,i,i,e)}}else return;let s=new(Ke(n)?Cr:Sr)(n,1);s.version=o;let c=a.get(e);c&&t.remove(c),a.set(e,s)}function u(e){let t=a.get(e);if(t){let n=e.index;n!==null&&t.version<n.version&&l(e)}else l(e);return a.get(e)}return{get:s,update:c,getWireframeAttribute:u}}function Ys(e,t,n){let r;function i(e){r=e}let a,o;function s(e){a=e.type,o=e.bytesPerElement}function c(t,i){e.drawElements(r,i,a,t*o),n.update(i,r,1)}function l(t,i,s){s!==0&&(e.drawElementsInstanced(r,i,a,t*o,s),n.update(i,r,s))}function u(e,i,o){if(o===0)return;t.get(`WEBGL_multi_draw`).multiDrawElementsWEBGL(r,i,0,a,e,0,o);let s=0;for(let e=0;e<o;e++)s+=i[e];n.update(s,r,1)}function d(e,i,s,c){if(s===0)return;let u=t.get(`WEBGL_multi_draw`);if(u===null)for(let t=0;t<e.length;t++)l(e[t]/o,i[t],c[t]);else{u.multiDrawElementsInstancedWEBGL(r,i,0,a,e,0,c,0,s);let t=0;for(let e=0;e<s;e++)t+=i[e]*c[e];n.update(t,r,1)}}this.setMode=i,this.setIndex=s,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function Xs(e){let t={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function r(t,r,i){switch(n.calls++,r){case e.TRIANGLES:n.triangles+=i*(t/3);break;case e.LINES:n.lines+=i*(t/2);break;case e.LINE_STRIP:n.lines+=i*(t-1);break;case e.LINE_LOOP:n.lines+=i*t;break;case e.POINTS:n.points+=i*t;break;default:B(`WebGLInfo: Unknown draw mode:`,r);break}}function i(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:t,render:n,programs:null,autoReset:!0,reset:i,update:r}}function Zs(e,t,n){let r=new WeakMap,i=new Wt;function a(a,o,s){let c=a.morphTargetInfluences,l=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=l===void 0?0:l.length,d=r.get(o);if(d===void 0||d.count!==u){d!==void 0&&d.texture.dispose();let e=o.morphAttributes.position!==void 0,n=o.morphAttributes.normal!==void 0,a=o.morphAttributes.color!==void 0,s=o.morphAttributes.position||[],c=o.morphAttributes.normal||[],l=o.morphAttributes.color||[],f=0;e===!0&&(f=1),n===!0&&(f=2),a===!0&&(f=3);let p=o.attributes.position.count*f,m=1;p>t.maxTextureSize&&(m=Math.ceil(p/t.maxTextureSize),p=t.maxTextureSize);let h=new Float32Array(p*m*4*u),g=new qt(h,p,m,u);g.type=_,g.needsUpdate=!0;let v=f*4;for(let t=0;t<u;t++){let r=s[t],o=c[t],u=l[t],d=p*m*4*t;for(let t=0;t<r.count;t++){let s=t*v;e===!0&&(i.fromBufferAttribute(r,t),h[d+s+0]=i.x,h[d+s+1]=i.y,h[d+s+2]=i.z,h[d+s+3]=0),n===!0&&(i.fromBufferAttribute(o,t),h[d+s+4]=i.x,h[d+s+5]=i.y,h[d+s+6]=i.z,h[d+s+7]=0),a===!0&&(i.fromBufferAttribute(u,t),h[d+s+8]=i.x,h[d+s+9]=i.y,h[d+s+10]=i.z,h[d+s+11]=u.itemSize===4?i.w:1)}}d={count:u,texture:g,size:new U(p,m)},r.set(o,d);function y(){g.dispose(),r.delete(o),o.removeEventListener(`dispose`,y)}o.addEventListener(`dispose`,y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)s.getUniforms().setValue(e,`morphTexture`,a.morphTexture,n);else{let t=0;for(let e=0;e<c.length;e++)t+=c[e];let n=o.morphTargetsRelative?1:1-t;s.getUniforms().setValue(e,`morphTargetBaseInfluence`,n),s.getUniforms().setValue(e,`morphTargetInfluences`,c)}s.getUniforms().setValue(e,`morphTargetsTexture`,d.texture,n),s.getUniforms().setValue(e,`morphTargetsTextureSize`,d.size)}return{update:a}}function Qs(e,t,n,r){let i=new WeakMap;function a(a){let o=r.render.frame,c=a.geometry,l=t.get(a,c);if(i.get(l)!==o&&(t.update(l),i.set(l,o)),a.isInstancedMesh&&(a.hasEventListener(`dispose`,s)===!1&&a.addEventListener(`dispose`,s),i.get(a)!==o&&(n.update(a.instanceMatrix,e.ARRAY_BUFFER),a.instanceColor!==null&&n.update(a.instanceColor,e.ARRAY_BUFFER),i.set(a,o))),a.isSkinnedMesh){let e=a.skeleton;i.get(e)!==o&&(e.update(),i.set(e,o))}return l}function o(){i=new WeakMap}function s(e){let t=e.target;t.removeEventListener(`dispose`,s),n.remove(t.instanceMatrix),t.instanceColor!==null&&n.remove(t.instanceColor)}return{update:a,dispose:o}}var $s={1:`LINEAR_TONE_MAPPING`,2:`REINHARD_TONE_MAPPING`,3:`CINEON_TONE_MAPPING`,4:`ACES_FILMIC_TONE_MAPPING`,6:`AGX_TONE_MAPPING`,7:`NEUTRAL_TONE_MAPPING`,5:`CUSTOM_TONE_MAPPING`};function ec(e,t,n,r,i){let a=new Kt(t,n,{type:e,depthBuffer:r,stencilBuffer:i}),o=new Kt(t,n,{type:v,depthBuffer:!1,stencilBuffer:!1}),s=new Mr;s.setAttribute(`position`,new wr([-1,3,0,-1,-1,0,3,-1,0],3)),s.setAttribute(`uv`,new wr([0,2,0,0,2,0],2));let c=new po({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
void main() {
    ...
    `,side:0,depthWrite:!1,depthTest:!1}));return i.frustumCulled=!1,i.renderOrder=-999,i}function Pd(){yd=new No(new J(ed.horizonColor).multiplyScalar(.8),new J(`#4a3820`),ed.hemiIntensity),sd.add(yd),vd=new Wo(new J(`#ffeedd`),ed.sunLightIntensity),vd.position.copy(xd).multiplyScalar(50),vd.target.position.set(0,0,0),sd.add(vd),sd.add(vd.target);let e=new Go(new J(ed.bottomColor).multiplyScalar(.6),ed.ambientIntensity);sd.add(e)}function Fd(){cd.aspect=window.innerWidth/window.innerHeight,cd.updateProjectionMatrix(),od.setSize(window.innerWidth,window.innerHeight),od.setPixelRatio(Math.min(window.devicePixelRatio,Q.maxPixelRatio))}function Id(){let e=new so(260,260,120,120);e.rotateX(-Math.PI/2);let t=e.attributes.position;for(let e=0;e<t.count;e++){let n=t.getX(e),r=t.getZ(e),i=Math.sin(n*.035)*.09+Math.cos(r*.03)*.09+Math.sin((n+r)*.02)*.06;t.setY(e,i)}t.needsUpdate=!0,e.computeVertexNormals();let n=new Float32Array(t.count*3),r=new J(3112242),i=new J(2055978),a=new J(5025616);for(let e=0;e<t.count;e++){let o=t.getX(e),s=t.getZ(e),c=.5+.5*Math.sin(o*.09)*Math.cos(s*.08),l=.5+.5*Math.sin((o+s)*.05),u=c*.65+l*.35,d=r.clone().lerp(i,(1-u)*.55).lerp(a,u*.45);n[e*3+0]=d.r,n[e*3+1]=d.g,n[e*3+2]=d.b}e.setAttribute(`color`,new xr(n,3));let o=new Wr(e,new mo({vertexColors:!0,roughness:1,metalness:0}));o.position.y=0,o.receiveShadow=!1;let s=Zd()?22e3:55e3,c=new Mr,l=new Float32Array(s*3),u=new Float32Array(s),d=new Float32Array(s);function f(e,t){return Math.sin(e*.035)*.09+Math.cos(t*.03)*.09+Math.sin((e+t)*.02)*.06}for(let e=0;e<s;e++){let t=(Math.random()-.5)*250,n=(Math.random()-.5)*250,r=f(t,n)+.01;l[e*3+0]=t,l[e*3+1]=r,l[e*3+2]=n,u[e]=.035+Math.random()*.055,d[e]=Math.random()*Math.PI*2}c.setAttribute(`position`,new xr(l,3)),c.setAttribute(`aSize`,new xr(u,1)),c.setAttribute(`aPhase`,new xr(d,1));let p=new ti({uniforms:{uTime:{value:0}},vertexShader:`
      uniform float uTime;
    ...
    `,transparent:!0,depthWrite:!1}),m=new Bi(c,p);return m.renderOrder=-10,o.add(m),o.userData.update=e=>{p.uniforms.uTime.value=e},o}function Ld(){let e=Rd(),t=new mo({color:16777215,roughness:.7,metalness:.05,vertexColors:!0,side:2}),n=new Ei(e,t,Q.flowerCount);n.instanceMatrix.setUsage(We);let r=[new J(16738740),new J(16716947),new J(16758465),new J(16739229),new J(16761035),new J(16748459),new J(16748964),new J(14381203),new J(16757721),new J(16731528)],i=new Float32Array(Q.flowerCount*3),a=new Float32Array(Q.flowerCount),o=new Float32Array(Q.flowerCount),s=new q,c=new Dt,l=new W,u=new W;for(let e=0;e<Q.flowerCount;e++){let t=Q.clearRadius+$(0,1)*(Q.fieldRadius-Q.clearRadius),d=$(0,Math.PI*2),f=Math.cos(d)*t+$(-2.5,2.5),p=Math.sin(d)*t+$(-2.5,2.5),m=$(.6,1.6),h=$(.65,1.4),g=$(-.18,.18),_=$(-.18,.18),v=$(0,Math.PI*2);u.set(f,0,p),c.setFromEuler(new Mn(g,v,_,`XYZ`)),l.set(h,h*m,h),s.compose(u,c,l),n.setMatrixAt(e,s);let y=wd(r).clone();y.offsetHSL($(-.02,.02),$(-.03,.03),$(-.04,.04)),i[e*3+0]=y.r,i[e*3+1]=y.g,i[e*3+2]=y.b,a[e]=$(.3,1.1),o[e]=$(0,Math.PI*2)}return n.instanceColor=new vi(i,3),n.instanceMatrix.needsUpdate=!0,Q.enableWind&&(n.geometry.setAttribute(`aSway`,new vi(a,1)),n.geometry.setAttribute(`aPhase`,new vi(o,1)),zd(n)),n.position.y=0,sd.add(n),{mesh:n,material:t,updateWind:e=>{let n=t.userData.shader;n&&(n.uniforms.uTime.value=e)}}}function Rd(){let e=new Ki(.035,.055,1.5,8);e.translate(0,.75,0);let t=Dd(.4,.18),n=t.clone();n.rotateZ(-.65),n.translate(.2,.6,.06);let r=t.clone();r.rotateZ(.65),r.rotateY(Math.PI*.7),r.translate(-.18,.75,-.04);let i=new co(Od(),16),a=i.attributes.position;for(let e=0;e<a.count;e++){let t=a.getX(e),n=a.getY(e),r=Math.sin(n/.7*Math.PI)*Math.abs(t)*1.5;a.setZ(e,r)}a.needsUpdate=!0,i.computeVertexNormals();let o=[];for(let e of[{count:6,size:.8,out:.5,radius:.1},{count:8,size:1,out:.65,radius:0}])for(let t=0;t<e.count;t++){let n=t/e.count*Math.PI*2+Cd()*.1,r=i.clone();r.scale(e.size,e.size,e.size),r.rotateY(n),r.rotateX(e.out),r.translate(0,1.55,e.radius),o.push(r)}let s=new uo(.12,14,12);s.translate(0,1.55,0);let c=Qu([e,n,r,...o,s],!1),l=c.attributes.position,u=new Float32Array(l.count*3),d=new J(2996334),f=new J(2267477),p=new J(16777215),m=new J(16766720);for(let e=0;e<l.count;e++){let t=l.getX(e),n=l.getY(e),r=l.getZ(e),i=Math.sqrt(t*t+r*r),a=p;n<1.2?a=d:n<1.35&&i>.14?a=f:n>1.48&&i<.16&&(a=m),u[e*3+0]=a.r,u[e*3+1]=a.g,u[e*3+2]=a.b}return c.setAttribute(`color`,new xr(u,3)),c.computeVertexNormals(),c}function zd(e){let t=e.material;t.onBeforeCompile=e=>{e.uniforms.uTime={value:0},t.userData.shader=e,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
         ...
         transformed.x += sin(t * 1.3) * 0.08 * topBend * aSway;`),e.fragmentShader=e.fragmentShader.replace(`diffuseColor.rgb *= vInstanceColor;`,`if (vColor.r > 0.9 && vColor.g > 0.9 && vColor.b > 0.9) { diffuseColor.rgb *= vInstanceColor; }`)},t.needsUpdate=!0}function Bd(){let e=new Ei(kd(1),new _r({color:16717636,side:2,transparent:!0,opacity:.8,blending:2}),Q.heartCount);e.instanceMatrix.setUsage(We);let t=[],n=[],r=[],i=new q,a=new Dt,o=new W(1,1,1),s=new W;for(let c=0;c<Q.heartCount;c++){let l=$(0,Q.fieldRadius*1.2),u=$(0,Math.PI*2),d=Math.cos(u)*l,f=Math.sin(u)*l,p=$(Q.heartStartYMin,Q.heartStartYMax);s.set(d,p,f),a.setFromEuler(new Mn($(0,Math.PI),$(0,Math.PI*2),$(0,Math.PI))),o.setScalar(Q.heartScale*$(.5,1.5)),i.compose(s,a,o),e.setMatrixAt(c,i),t.push(new W(d,p,f)),n.push($(Q.heartFallSpeedMin,Q.heartFallSpeedMax)),r.push($(0,Math.PI*2))}return e.instanceMatrix.needsUpdate=!0,sd.add(e),{mesh:e,update:(s,c)=>{for(let l=0;l<Q.heartCount;l++){let u=t[l];u.y+=n[l]*s;let d=Math.sin(c+r[l])*.5,f=Math.cos(c+r[l]*.7)*.3;if(u.x+=d*s,u.z+=f*s,u.y<0){let e=$(0,Q.fieldRadius*1.2),t=$(0,Math.PI*2);u.x=Math.cos(t)*e,u.z=Math.sin(t)*e,u.y=$(Q.heartStartYMin,Q.heartStartYMax),n[l]=$(Q.heartFallSpeedMin,Q.heartFallSpeedMax)}i.compose(u,a,o),e.setMatrixAt(l,i)}e.instanceMatrix.needsUpdate=!0}}}function Vd(){let e=new fi;e.name=`RoseGroup`;let t=Hd(new mo({color:2002772,roughness:.85,metalness:0}));t.name=`RoseStem`,e.add(t),Ud(e,t,new mo({color:1333818,roughness:.7,metalness:0}));let n=new mo({color:1735237,roughness:.8,metalness:0,side:2}),r=Qu([Ed(new W(.08,.28,.03),new Mn(0,0,-.9),.1,.15,.07,8),Ed(new W(-.075,.38,-.025),new Mn(0,Math.PI,.85),.1,.14,.065,8),Ed(new W(.02,.45,.08),new Mn(0,Math.PI*.5,-.7),.1,.13,.06,7)],!1);r.computeVertexNormals();let i=new Wr(r,n);i.name=`RoseLeaves`,e.add(i);let a=new mo({color:16717636,roughness:.28,metalness:.08,emissive:3342344,emissiveIntensity:.65,side:2,clearcoat:.45,clearcoatRoughness:.3}),o=Wd();o.computeVertexNormals();let s=new Wr(o,a);s.name=`RosePetals`,e.add(s);let c=new Gi(.18,.55,8,12);c.translate(0,.42,0);let l=new Wr(c,new _r({transparent:!0,opacity:0}));l.name=`RoseCollider`,e.add(l);let u=new Vo(16731501,1.2,5);u.position.set(.3,1,.2),e.add(u);let d=new Vo(16748451,.6,4);d.position.set(-.2,.8,-.15),e.add(d),e.position.copy(Q.rosePosition);let f=Q.roseHeight/.95;e.scale.setScalar(f);let p=new zo(16739210,2,18,Math.PI/6,.35,1);p.position.copy(xd).multiplyScalar(10).add(new W(0,4,0)),p.target=e,sd.add(p),sd.add(p.target),sd.add(e);let m=e.rotation.clone(),h=e.scale.clone();function g(t){let n=Math.sin(t*.85)*.055,r=Math.cos(t*.65)*.028;e.rotation.y=m.y+n,e.rotation.z=m.z+r;let i=1+Math.sin(t*1.1)*.015;e.scale.set(h.x*i,h.y*(1+Math.sin(t*1.1+1.2)*.012),h.z*i)}return{group:e,stemMesh:t,leavesMesh:i,petalsMesh:s,colliderMesh:l,animateRose:g}}function Hd(e){let t=.65,n=new na([new W(0,0,0),new W(.06,t*.33,.02),new W(-.05,t*.66,-.02),new W(.02,t*1,.01)]),r=new fo(n,120,1,14,!1),i=.052,a=.028,o=r.attributes.position,s=n.computeFrenetFrames(120,!1),c=new W,l=new W;for(let e=0;e<=120;e++){let t=e/120,r=Et.lerp(i,a,t);l.copy(n.getPointAt(t));let u=s.normals[e],d=s.binormals[e];for(let t=0;t<15;t++){let n=e*15+t;c.fromBufferAttribute(o,n).sub(l);let i=c.dot(u),a=c.dot(d),s=new W().addScaledVector(u,i).addScaledVector(d,a);s.lengthSq()<1e-8?s.copy(u).multiplyScalar(r):s.setLength(r);let f=new W().copy(l).add(s);o.setXYZ(n,f.x,f.y,f.z)}}r.computeVertexNormals();let u=new Wr(r,e);return u.userData.curve=n,u.userData.radiusAt=e=>Et.lerp(i,a,e),u}function Ud(e,t,n){let r=t.userData.curve,i=t.userData.radiusAt,a=new qi(.012,.055,10,1);a.rotateX(Math.PI/2),a.translate(0,0,.03);for(let t=0;t<9;t++){let o=t/8,s=Et.lerp(.18,.74,o),c=r.getPointAt(s),l=r.getTangentAt(s).normalize(),u=new W(0,1,0);Math.abs(l.dot(u))>.9&&(u=new W(1,0,0));let d=new W().crossVectors(l,u).normalize(),f=new W().crossVectors(d,l).normalize(),p=o*Math.PI*2*1.8+t*.45,m=new W().addScaledVector(d,Math.cos(p)).addScaledVector(f,Math.sin(p)).normalize(),h=i(s)*.98,g=new W().copy(c).addScaledVector(m,h),_=new Wr(a,n);_.position.copy(g),_.lookAt(new W().copy(g).add(m)),_.rotateZ((Math.random()-.5)*.25),_.rotateY((Math.random()-.5)*.18),e.add(_)}}function Wd(){let e=(e,t)=>(e%t+t)%t,t=new Float32Array(28*320*3),n=new Uint32Array(27*319*6),r=Math.PI*2,i=0;for(let n=0;n<28;n++){let a=n/27;for(let n=0;n<320;n++){let o=-r+n/319*(17*Math.PI),s=Math.PI/2*Math.exp(-o/(8*Math.PI)),c=1-.5*(5/4*(1-(1-e(3.6*o,r)/Math.PI)**2)-.25)**2;c=Et.clamp(c,.05,1.35);let l=1.95653*a**2*(1.27689*a-1)**2*Math.sin(s),u=c*(a*Math.sin(s)+l*Math.cos(s)),d=c*(a*Math.cos(s)-l*Math.sin(s)),f=.002;!Number.isFinite(u)||!Number.isFinite(d)?(u=f,d=0):u<f&&(u=f);let p=.3;u*=p,d*=p;let m=u*Math.sin(o),h=d+.62,g=u*Math.cos(o),_=i*3;t[_]=m,t[_+1]=h,t[_+2]=g,i++}}let a=0;for(let e=0;e<27;e++)for(let t=0;t<319;t++){let r=e*320+t,i=(e+1)*320+t,o=(e+1)*320+(t+1),s=e*320+(t+1);n[a++]=r,n[a++]=i,n[a++]=s,n[a++]=i,n[a++]=o,n[a++]=s}let o=new Mr;return o.setAttribute(`position`,new xr(t,3)),o.setIndex(new xr(n,1)),o.computeVertexNormals(),o.computeBoundingSphere(),o}function Gd(){od.domElement.addEventListener(`pointerdown`,Kd,{passive:!0})}function Kd(e){let t=performance.now();if(t-gd<Q.tapCooldownMs)return;gd=t;let n=od.domElement.getBoundingClientRect(),r=(e.clientX-n.left)/n.width*2-1,i=-((e.clientY-n.top)/n.height*2-1);fd.set(r,i),dd.setFromCamera(fd,cd),dd.intersectObject(md.colliderMesh,!1).length&&qd()}function qd(){_d||(_d=!0,td?.classList?.add(`hide`),nd?.classList?.add(`show`),Yd())}function Jd(){rd?.addEventListener(`click`,()=>{let e=nd?.querySelector?.(`.title`);e&&(e.textContent=`Wujuuuuuuu!! 💖🌹`),id&&(id.style.display=`none`),rd&&(rd.textContent=`Te amoooooo 💖😭`)}),id?.addEventListener(`pointerenter`,()=>{let e=(Math.random()-.5)*220,t=(Math.random()-.5)*120;id.style.transform=`translate(${e}px, ${t}px)`})}function Yd(){try{let e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),n=e.createGain();t.type=`sine`,t.frequency.setValueAtTime(880,e.currentTime),t.frequency.exponentialRampToValueAtTime(1320,e.currentTime+.08),t.frequency.exponentialRampToValueAtTime(660,e.currentTime+.22),n.gain.setValueAtTime(1e-4,e.currentTime),n.gain.exponentialRampToValueAtTime(.1,e.currentTime+.02),n.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+.28),t.connect(n).connect(e.destination),t.start(),t.stop(e.currentTime+.3),t.onended=()=>e.close()}catch{}}function Xd(){requestAnimationFrame(Xd);let e=ud.getDelta(),t=ud.getElapsedTime();Q.enableWind&&pd&&pd.updateWind(t),md&&md.animateRose(t),hd&&hd.update(e,t),ld||cd.lookAt(Q.lookAt),ld&&ld.update(),od.render(sd,cd)}function Zd(){return/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)}function Qd(){try{let e=document.createElement(`canvas`),t=e.getContext(`webgl2`),n=e.getContext(`webgl`)||e.getContext(`experimental-webgl`);return!!(t||n)}catch{return!1}}function $d(){let e=document.getElementById(`overlay`)||(()=>{let e=document.createElement(`div`);return e.id=`overlay`,document.body.appendChild(e),e})();if(!document.getElementById(`hint`)){let t=document.createElement(`div`);t.id=`hint`,t.textContent=`Mi Rosa 🌹`,e.appendChild(t)}if(!document.getElementById(`card`)){let t=document.createElement(`div`);t.id=`card`,t.innerHTML=`
      <div class="title">Will you be my valentine?</div>
      <div class="actions">
        <button id="yes" type="button">Si 💖</button>
        <button id="no" type="button">No 🙈</button>
      </div>`,e.appendChild(t)}if(!document.getElementById(`fallback`)){let t=document.createElement(`div`);t.id=`fallback`,t.textContent=`Your browser doesn't support WebGL. Will you be my valentine? 💖`,e.appendChild(t)}}